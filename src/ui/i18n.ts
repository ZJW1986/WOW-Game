...
export const messages = {
  "zh-CN": {
    ...
    ideaDialog: {
      ...
      generate: "生成游戏",
      generateAssets: "生成素材",
      readyForAssets: "信息已补全。请先生成素材，确认素材方向后再生成可玩游戏。",
      statusConfirmAssets: "请先确认背景、角色、障碍和收集物。",
      statusGenerateAssetsNext: "问题已完成，请继续生成核心素材。",
      statusCoreAssetsConfirmed: "核心素材已确认，可以生成可玩版本。",
